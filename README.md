...
- [Plaid API](https://plaid.com/docs/api/)
  - The following Plaid API product endpoints were used to build CapitalGuard (*Note: all Plaid API endpoint requests return JSON responses*):
    ...
    - [Auth](https://plaid.com/docs/api/products/#auth): retrieve and verify bank account and bank identification numbers (e.g. routing numbers), in addition to high-level account auth data
